    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Seus clientes</h1>
        </div>
        <?php
        $cod_usuario=$_SESSION['cod'];
        $sql="SELECT  * FROM clientes_usuario WHERE cod_usuario ='$cod_usuario' LIMIT 1";
        $tabela=mysqli_query($conexao, $sql);
        $row= mysqli_num_rows($tabela);
        if ($row==1) {
          $sql="SELECT * FROM clientes_usuario WHERE cod_usuario=".$cod_usuario;
          $tabela = mysqli_query($conexao,$sql);
          while ($linha = mysqli_fetch_array($tabela))
          {
            ...
            <table align=center border=1 width=100%>
              <tr>
                <td align=center colspan=8>SEUS CLIENTES</td>
              </tr>
              <td align="center">
                <b>COD</b>
              </td>
              ...
              <tr>
                <td align="center">
                  <a href="ordem_compra_cliente_existe.php?cod_cliente=<?php echo $linha['cod_clientes'] ?>"><?php echo $linha['cod_clientes']; ?></a>
                </td>
                <td>
                  <?php echo $linha['nome']; ?>
                </td>
                ...
                <td width=50 align="center">
                  <a href="altera_c.php?acao=altera&cod=<?php echo $linha['cod_clientes']; ?>">
...
<?php
  ...
  echo "Nenhuma venda foi feita, logo, não há clientes cadastrados.";
}
