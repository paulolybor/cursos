    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Suas vendas</h1>
        </div>
        <table align=center border=1 width=100%>
          <tr>
            <td align=center colspan=8>Suas vendas</td>
          </tr>
          <td align="center">
            <b>COD</b>
          </td>
          ...
          <td><b>Preço</b></td>
          <td><b>Quantidade produtos</b></td>
          <td><b>Envio da ordem por email</b></td>
          
          <?php
          $cod_usuario=$_SESSION['cod'];
          $sql="SELECT  * FROM vendas WHERE cod_usuario ='$cod_usuario' LIMIT 1";
          $tabela=mysqli_query($conexao, $sql);
          $row= mysqli_num_rows($tabela);
          if ($row == 1) {
            $sql="SELECT * FROM vendas WHERE cod_usuario=".$cod_usuario;
            $tabela = mysqli_query($conexao,$sql);
            while ($linha = mysqli_fetch_array($tabela))
            {
              ...
              <tr>
                ...
                <td>
                  <?php echo $linha['quantidade_produtos']; ?>
                </td>
                <td>
                  <a href="enviar_email.php?cod_venda=<?php echo $linha['cod_venda']; ?>">
...
<?php
  ...
  echo "Nenhuma venda efetuada <a href='ordem_compra.php'><strong>ABRIR ORDEM DE COMPRA</strong></a>";
}
